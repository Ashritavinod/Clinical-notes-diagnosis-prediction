...
model = BertForSequenceClassification.from_pretrained("C:/Users/ashri\Downloads\Clinical Notes Diagnosis Prediction\patient_model")
tokenizer = BertTokenizer.from_pretrained('C:/Users/ashri\Downloads\Clinical Notes Diagnosis Prediction\patient_model')
label_encoder = pickle.load(open("C:/Users/ashri\Downloads\Clinical Notes Diagnosis Prediction\label_encoder.pkl", 'rb'))
